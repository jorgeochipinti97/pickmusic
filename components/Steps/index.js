  ...
  return (
    <>
      <Swiper
        ...
        className="mySwiper"
      >
        <SwiperSlide className="w-screen md:w-fit rounded-xl">
          {" "}
          <Card className="border-none  flex-col flex items-center justify-start bg-gradient-to-tr from-green-800 to-slate-900">
            ...
            <CardHeader>
              ...
              <CardTitle className="text-center text-white font-sans mt-10 text-3xl">
                Selecciona tu taza
              </CardTitle>
              <CardContent>
                <p className="font-sans text-gray-200 text-center">
        ...
        <SwiperSlide className="w-fit rounded-xl">
          <Card className="border-none  flex-col flex items-center justify-start bg-gradient-to-tr from-green-800 to-slate-900">
            ...
            <CardHeader>
              ...
              <CardTitle className="text-center text-gray-300 font-sans mt-10 text-3xl">
